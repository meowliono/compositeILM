...
using namespace std;
double cluster_log_likelihood(map<int, vector<Individual>> clusters, int t_end, int K, double a0, double a1, double beta, double eps);
double cluster_log_likelihood_tv(map<int, vector<Individual>> clusters, int t_end, int K, double a0, double a1, double beta, double eps, double delta);
...
double cluster_log_likelihood_bc_tilde_woeps_infcentroids(map<int, vector<Individual>> clusters, vector<DataPoint> centroids, int t_end, int id, double a0, double a1, double beta, double tilde_beta);
